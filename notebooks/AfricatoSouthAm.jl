...
begin
	#TODO: Separate these into separate cells -
	# Paradigm for Pluto is to have each cell be one thing.
...
md"""
Now I will use kmercombining to get a collection that contains only 3mers
that exist in Egypt and Ghana, and Egypt and Peru.
I can later get the lengths of these to compare how many kmers are in common
for each
"""
